...
<footer class="container-fluid">
    <div class="row footer">
        <div class="col-12">
            <p class="pt-2 mb-2 text-center">Copyright &copy; <a class="footer-link" href="">@if(isset($footer)){{ $footer->copyright }} @else 2020 @endif</a> || Developed  by:
                <a class="footer-link" href="http://www.averfresh.com">webatozexpert</a></p>
        </div>
    </div>
</footer>
<!--Footer End-->
