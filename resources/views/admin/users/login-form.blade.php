        ...
        <div class="col-12 pl-0 pr-0">
            ...
            @csrf
                <div class="form-group col-12 mb-3">
                    ...
                    <input id="email" type="mobile" class="col-sm-9 form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ old('mobile') }}" placeholder="Enrer Your Mobile Number " required autofocus>
                    @error('mobile')
